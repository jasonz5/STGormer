...
from model.transformer.SubLayers import MultiHeadAttention, PositionwiseFeedForward, SharedMoEFNN, MoEFNN , STMoEFNN, SoftMoEFNN
...
class EncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        if moe_status == 'SoftMoE':
            self.pos_ffn = SoftMoEFNN(d_model, num_experts, dropout=moe_dropout)
        elif moe_status == 'SharedMoE':
